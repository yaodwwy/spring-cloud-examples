...
/**
 * @author Adam 2023/11/3 16:18 说明:
 * @link org.springframework.security.core.userdetails.User
 * @since 2023/11/3 16:18
 */
@Data
@Builder
public class User implements UserDetails, CredentialsContainer {
    ...
    public Collection<GrantedAuthority> getAuthorities() {
        ...
        Set<SimpleGrantedAuthority> collected = Arrays.stream(roles.split(","))
        ...
        sortedAuthorities.addAll(collected);
    ...
    public void setRoles(String ... roles) {
        ...
        SortedSet<GrantedAuthority> sortAuthorities = sortAuthorities(authorities);
        this.authorities = Collections.unmodifiableSet(sortAuthorities);
        this.roles = StringUtils.join(authorities, ",");
    }
