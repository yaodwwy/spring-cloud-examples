...
public class DemoAuthorizationServerApplicationTests {
	...
	public void whenLoginSuccessfulThenDisplayBadRequestError() throws IOException {
		...
		val statusCode = signInResponse.getStatusCode();
		String statusMessage = signInResponse.getStatusMessage();
		log.info("statusCode==> {},{}",statusCode,statusMessage);
		assertThat(statusCode).isEqualTo(HttpStatus.BAD_REQUEST.value());	// there is no "default" index page
	}
