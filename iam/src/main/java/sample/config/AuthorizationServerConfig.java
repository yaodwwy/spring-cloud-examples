...
public class AuthorizationServerConfig {
	...
	public RegisteredClientRepository registeredClientRepository(JdbcTemplate jdbcTemplate) {
		RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString() + "1")
		...
		RegisteredClient pmClient = RegisteredClient.withId("pm-client")
				.clientId("pm-client")
				.clientSecret("{noop}pm-secret")
		...
		RegisteredClient deviceClient = RegisteredClient.withId(UUID.randomUUID().toString() + "3")
